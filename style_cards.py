        ...
        new_grid = """
            <div class="grid md:grid-cols-3 gap-8 text-left">
                ...
                <div class="bg-blue-50/70 rounded-2xl p-10 hover:shadow-md transition duration-300">
                    ...
                    <p class="text-gray-700 mb-6 text-sm leading-relaxed min-h-[80px]">Grade 6 supports students as they move from guided learning to greater independence, building confidence and responsibility within the CBSE framework.</p>
                    <ul class="space-y-3 text-sm text-gray-500">
