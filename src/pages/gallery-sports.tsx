...
export const GalleryPage = () => {
    ...
    <!-- Life at SNS College of Physiotherapy -->
...
export const SportsClubsPage = () => {
    ...
    <section class="py-16 bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="/admissions" class="bg-white text-primary-600 hover:bg-gray-100 px-8 py-4 rounded-xl font-bold text-lg transition inline-block">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-[2rem] p-12 text-center shadow-xl card-shadow-lg max-w-3xl mx-auto border border-gray-100 relative z-10 -mt-8">
                ...
                <p class="text-sm text-gray-500">
                    For printed copies, contact us at <a href="tel:+919003655855" class="text-blue-500 hover:underline font-medium">+91-90036 55855</a>
                </p>
            </div>
